	...
	<div class="row">
		<div class="col-sm-12">
			<div class="logo logo--main">
				<img src="<?php echo (bloginfo('template_directory') . '/assets/img/title.png') ?>" class="logo__image" alt="Umbilicus – Descent Team Delta">
			</div>
			<div class="center image-guys">
			...
			<div class="pixel subtitles">
				...
				<ul class="credits credits--mini">
					...
					<li><img src="<?php echo (bloginfo('template_directory') . '/assets/img/PlayerYellow.png') ?>" class="astronaut"><a href="http://twitter.com/coreywarning">Corey Warning</a></li>
					<li><img src="<?php echo (bloginfo('template_directory') . '/assets/img/PlayerWhite.png') ?>" class="astronaut"><a href="http://twitter.com/andrew_pomeroy">Andrew Pomeroy</a></li>
				</ul>
			</div>
		</div>
	</div>
